...
namespace APIfilms.Migrations
{
    ...
    [Migration("20250225134038_CreationBDFilmRatings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APIfilms.Models.Notation", b =>
                {
            ...
            modelBuilder.Entity("APIfilms.Models.Utilisateur", b =>
                {
                    b.Property<int>("UtilisateurId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("APIfilms.Models.Notation", b =>
                {
                    b.HasOne("APIfilms.Models.Film", "FilmNote")
                        .WithMany("NotesFilm")
                        .HasForeignKey("FilmId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("APIfilms.Models.Utilisateur", "UtilisateurNotant")
